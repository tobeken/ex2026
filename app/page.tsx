    ...
    <div className="w-full max-w-6xl mx-auto px-6 py-12">
      <div className="grid md:grid-cols-3 gap-8">
        <div className="md:col-span-2 space-y-4 text-sm leading-7">
          ...
          <p>
            本ウェブサイトはランサーズに掲載中の「音声チャットボットを使った調べ物タスク」を行うためのサイトです。
          </p>
          <p>
            本タスクは、兵庫県立大学山本研究室が実施する研究プロジェクトの一環として行われます。
            タスク依頼者が指定した3つのトピックについて音声チャットボットと会話をしながら調べ物をしていただきます。
          ...
          <p className="font-semibold">
            以上をお読みになり同意いただける方のみ、IDを入力の上、ログインボタンをクリックしてタスクを開始してください。
          </p>
        </div>
