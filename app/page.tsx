    ...
    <div className="w-full max-w-6xl mx-auto px-6 py-12">
      <div className="grid md:grid-cols-3 gap-8">
        <div className="md:col-span-2 space-y-4 text-sm leading-7">
          ...
          <p>
            本ウェブサイトは「音声チャットボットを使った調べ物タスク」を行うためのサイトです。
          </p>
          <p>
            本タスクは、兵庫県立大学山本研究室が実施する研究プロジェクトの一環として行われます。
          </p>
          <p>
            本タスクは合計2回実施します。２回目は1回目のタスク実施後の約１週間経過してから行っていただきます。２回とも、タスク依頼者が指定した3つのトピックについて音声チャットボットと会話をしながら調べ物をしていただきます。調べ物が終了後、トピックについてあなたの調べた結果やシステムに関するアンケートに答えていただきます。
          </p>
          <p className="font-semibold">
            途中で辞めた場合は、一旦我々のシステムにデータが保存されますが、データ回収時に当該データを削除します。
          </p>
          <p className="font-semibold">
            本タスクは PC のみで行うことができます。スマートフォンやタブレットからご参加することはできません。
          </p>
          <p>
            アンケートに回答いただいた内容や、タスク中の音声のチャットボットとのやり取りのログ（音声データを含みます）を記録させていただきます。収集したデータは匿名化され、学術研究活動以外の目的で使用することはありません。
          </p>
          <p>
          アンケート終了後であっても，同意撤回・データ削除の依頼があればデータを削除します。
          </p>
          <p>
          ただし，研究成果を公表したあとは，データを削除することはできません．
          </p>
          <p className="font-semibold">
            以上をお読みになった方は、メールアドレスを入力の上、ログインボタンをクリックしてタスクを開始してください。
          </p>
        </div>
        ...
        <div className="md:col-span-1 flex md:justify-end">
          <Card className="p-6 space-y-4 w-full max-w-sm shadow-lg">
            ...
            兵庫県立大学のメールアドレスを入力してログインすると Session 選択画面に進みます。
            </p>
          </Card>
        </div>
      </div>
